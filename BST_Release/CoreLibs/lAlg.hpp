...
namespace nsAlg{
	...
	template <class RandomAccessIterator, class T, class Compare = nsTempalate::compare<T>> extern UBINT Binary_Search(RandomAccessIterator first, RandomAccessIterator last, const T& value, Compare comp);
